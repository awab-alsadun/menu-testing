...
//CSV stands for Comma-Separated Values.It is a plain text file format used to store tabular data (numbers and text) in a structured way.
import java.sql.*; //JDBC API for connecting and interacting with the SQLite database.
...
public class inventorymanagementsystem {
    ...
    public static void menu(Connection conn) {
        ...
        while (true) {
            ...
            System.out.println("10. Export Products to CSV");
            ...
            switch (choice) {
                ...
                case 3 -> viewProductsByPriceRange(conn, scanner);
                case 4 -> updateProduct(conn, scanner);
                case 5 -> deleteProduct(conn, scanner);
                case 6 -> searchProductByName(conn, scanner);
                case 7 -> viewLowStockProducts(conn, scanner);
                case 8 -> calculateTotalInventoryValue(conn);
                case 9 -> sortProductsByPrice(conn, scanner);
                case 10 -> exportProductsToCSV(conn);
                case 11 -> {
